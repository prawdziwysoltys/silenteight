...
import org.openqa.selenium.support.ui.ExpectedConditions;import java.util.List;
...
public class DecisionTreePage extends PageObjectTemplate {
    ...
    public void openEditAssignmentWindow(){
        this.editAssignmentsButton.click();
    ...
    public boolean isBatchOnAssignedList(String bathName){
         for (WebElement positionOnList : this.assignedBatchList){
